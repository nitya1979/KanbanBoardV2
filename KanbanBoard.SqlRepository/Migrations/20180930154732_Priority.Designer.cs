...
namespace KanbanBoard.SqlRepository.Migrations
{
    ...
    [Migration("20180930154732_Priority")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KanbanBoard.SqlRepository.DbQuadrant", b =>
                {
                    ...
                    b.HasData(
                        new { QuadrantID = 1, CreateDate = new DateTime(2018, 9, 30, 11, 47, 32, 421, DateTimeKind.Local), CreatedBy = "system", QuadrantName = "Urgent And Important" },
                        new { QuadrantID = 2, CreateDate = new DateTime(2018, 9, 30, 11, 47, 32, 428, DateTimeKind.Local), CreatedBy = "system", QuadrantName = "Urgent But Not Important" },
                        new { QuadrantID = 3, CreateDate = new DateTime(2018, 9, 30, 11, 47, 32, 428, DateTimeKind.Local), CreatedBy = "system", QuadrantName = "Not Urgent But Important" },
                        new { QuadrantID = 4, CreateDate = new DateTime(2018, 9, 30, 11, 47, 32, 428, DateTimeKind.Local), CreatedBy = "system", QuadrantName = "Not Urgent And Not Important" }
                    );
                });
            ...
            modelBuilder.Entity("KanbanBoard.SqlRepository.DbProject", b =>
                {
                    b.HasOne("KanbanBoard.SqlRepository.DbQuadrant", "Qudrant")
                        .WithMany()
